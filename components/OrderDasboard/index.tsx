...
export function OrdersDashboard({ data, role }: OrdersProps) {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 mt-24 dark:bg-[#ffffff] shadow-md rounded-lg">
      ...
      <Card className="shadow-md">
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow className="text-gray-950">
                  ...
                  <TableCell>
                    <TooltipProvider>
                      <Tooltip delayDuration={2}>
                        <TooltipTrigger>
                          <button className="text-sm text-gray-800 text-primary hover:underline">
                            View Details
                          </button>
                        </TooltipTrigger>
